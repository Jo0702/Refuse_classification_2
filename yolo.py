...
class YOLO(object):
    _defaults = {
        ...
        #--------------------------------------------------------------------------#
        "model_path"        : 'logs/ep020-loss5.205-val_loss4.372.h5',
        "classes_path"      : 'model_data/lijunxuan02.txt',
        #---------------------------------------------------------------------#
        #   输入图片的大小，必须为32的倍数。
        #---------------------------------------------------------------------#
        "input_shape"       : [640, 640],
    ...
    def __init__(self, **kwargs):
        ...
        self.trabbish_info1 = { '纸杯' : '无，可回收垃圾'}
        self.trabbish_info2 = { '纸杯' : '重新浸泡打浆、制作纸张等，纸制品大部分都可以回收再利用'}
    ...
    def detect_image(self, image, crop = False, count = False):
        ...
        for i, c in list(enumerate(out_classes)):
            ...
            self.Predicted_Trabbish_name = predicted_class
            box             = out_boxes[i]
            score           = out_scores[i]
        ...
        self.result_t = '危害鸟种：' + f'<a href="{link_Baidu}" target="_blank">{predicted_class}</a>' 
    ...
    def show_result_table(result_1='1', result_2='2', result_3='3', result_4='4', result_5='5', result_6='6' , result_7='7' , Video=1 ):
        # st.markdown(Confidence_result + top_conf[top_label_index[0]] , unsafe_allow_html=True)
        # global Detection_result
        # global Confidence_result

        # while result_t:
        #     current_result = result_t.pop()
        # st.markdown(result_1, unsafe_allow_html=True)
        if Video == 1:
